...
# NOTA: Access Logging do API Gateway requer configuração de IAM Role a nível de conta
# AWS Academy não permite criar/configurar roles, então o logging está desabilitado
# Os logs das requisições podem ser vistos através do Container Insights nos microserviços
...
resource "aws_api_gateway_stage" "dev" {
  ...
  # Access Logging desabilitado - AWS Academy não suporta configuração de CloudWatch role
  # access_log_settings {
